...
<div class="row">
  <div class="column">
    <img src="2.jpeg" alt="Snow" style="width:100%">
  </div>
  <div class="column">
    <img src="5.jpg" alt="Forest" style="width:100%">
  </div>
  <div class="column">
    <img src="roomward.jpg" alt="Mountains" style="width:100%">
  </div>
</div>
...
<div class="hero">
        	<p>ROOM</p>
      		<div class="form-box">
	      		...
	      		<form  class="input-group" action="add4.php" method="post">
	      			<input type="text" name="room_no" class="input-field" placeholder="Room number:"  required>
	      			<input type="text" name="room_type" class="input-field" placeholder="Room Type:" required>
	      			<br>
					  <br>
					  <br>
           <br>
      ...
      <th>Room ID</th>
        ...
        <th>action</th>
            ...
            <td><?php echo $row['room_id']; ?></td>
							...
							<td>
								<a style="color: #800080; font-weight:600;"  href="edit4.php?id=<?php echo $row['room_id']; ?>">Edit</a>
								<a  style="color: #dc143c; font-weight:600;" href="delete4.php?id=<?php echo $row['room_id']; ?>">Delete</a>
							</td>
						</tr>
						<?php
					}
