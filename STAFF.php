...
<div class="row">
  <div class="column">
    <img src="staff.jpg" alt="Snow" style="width:100%">
  </div>
  <div class="column">
    <img src="3.jpg" alt="Forest" style="width:100%">
  </div>
  <div class="column">
    <img src="img.jpg" alt="Mountains" style="width:100%; height:293px;">
  </div>
</div>
...
<div class="hero">
        	<p>STAFF</p>
      		<div class="form-box">
	      		...
	      		<form id="login" class="input-group" action="add1.php" method="post">
        ...
        <th>Action</th>
            ...
            <td><?php echo $row['staff_id']; ?></td>
              ...
              <td><?php echo $row['gender']; ?></td>
							<td>
								<a style="color: #800080; font-weight:600;" href="edit1.php?id=<?php echo $row['staff_id']; ?>">Edit</a>
								<a  style="color: #dc143c; font-weight:600;" href="delete1.php?id=<?php echo $row['staff_id']; ?>">Delete</a>
							</td>
						</tr>
						<?php
					}
